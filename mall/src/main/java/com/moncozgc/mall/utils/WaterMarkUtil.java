...
/**
 * 图片水印工具类
 * https://blog.csdn.net/tanzongbiao/article/details/105531905
 */
public class WaterMarkUtil {
    ...
    // 水印文字字体
    private static final Font font = new Font("宋体", Font.BOLD, 100);
    // 水印文字颜色
    ...
    public static void markImage(String text, String srcImgPath, String targetPath, Integer degree) {
        ...
        try {
            ...
            positionWidth = imgWidth / 2;
            positionHeight = imgHeight - 50;
    ...
    public static void main(String[] args) throws IOException {
        ...
        String text = "MoncozGC";

        BufferedImage read = ImageIO.read(new FileInputStream(srcImgPath));
        ...
        // 给图片添加水印文字,水印文字旋转-45
        markImage(text, srcImgPath, "D:\\testSmileWithMarkRotate.jpg", -180);
