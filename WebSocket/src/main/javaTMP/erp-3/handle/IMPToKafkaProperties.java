...
//    private String kafkaHost = "192.168.153.100:9092";
     ...
     * 消费者：消费topic的组ID
     */
    private String groupId = "MON_IM_TEST";
    ...
    public IMPToKafkaProperties(String kafkaHost, String ack, Integer retryTimes, Integer batchSize, Integer lingerMs, Integer bufferMemory, String keyEncoder, String valueEncoder, String groupId, String autoCommit, String autoCommitIntervalMs, String keyDecoder, String valueDecoder, String autoOffsetReset, Collection<String> topic) {
